...
.view {
	background-image: url("images/viewstuden.jpg");
	background-size: cover;
	background-repeat: no-repeat;
	border: 5px solid yellow;
	padding: 3px;
...
<body>
	<div class="card">
		<nav class="d-flex justify-content-between p-2 border border-success">
			<img src="images/cjclogo.jpeg" width="100px" height="80px">
			<div class="pt-2">
				<a href="#enroll">
								...
								<form action="enroll_student">
									...
									<div class="row">
										...
										<div class="col">
											...
											</select> <label class="form-label select-label" name="batchNumber">Batch Number</label>
										</div>
									</div>
						...
						<tr>
							...
							<td>
								<div class="btn-group btn-group-sm" role="group"
									aria-label="...">
									<a class="btn btn-outline-success" href="fees?studentId=${s.studentId}">PayFees</a>
									<a class="btn btn-outline-primary" href="shiftbatch?studentId=${s.studentId}">ShiftBatch</a>
									<a class="btn btn-outline-danger" href="delete?studentId=${s.studentId}">Remove</a>
